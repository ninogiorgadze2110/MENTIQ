  ...
  template: `
    ...
    <div style="padding:40px 72px 72px; background:var(--paper); max-width:1280px; margin:0 auto;">
      <div style="text-align:center; max-width:640px; margin:0 auto 40px;">
        ...
        <p style="font-size:15px; line-height:1.65; color:color-mix(in srgb, var(--ink) 70%, transparent); margin:0;">დაიწყე 7 დღიანი უფასო ტრიალით. გადაიხადე მაშინ, როცა მზად იქნები — ან ტრიალის დასრულების შემდეგ.</p>
      </div>
      ...
      <div style="margin-top:56px;">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:0;">
          ...
          <div style="padding:18px 0 18px 24px;"><div style="font-family:var(--ge-serif); font-size:15px;">რა ხდება ტრიალის შემდეგ?</div><div style="font-size:13px; color:color-mix(in srgb, var(--ink) 65%, transparent); margin-top:4px; line-height:1.55;">წვდომა ჩერდება სანამ არ გამოიწერ. შენი პროგრესი შენახულია.</div></div>
        </div>
      </div>
    </div>
...
export class PricingComponent {
  ...
  readonly statusLine = computed(() => {
    ...
    if (s.isTrial) return `უფასო ტრიალი აქტიურია — დარჩა ${s.daysRemaining} დღე.`;
